...
export const zh: Translations = {
  ...
  notifications: {
    ...
    errors: {
      ...
      geminiRateLimitRetrying: 'Gemini 触发速率限制 — 正在自动重试。',
      geminiRateLimitExhausted: 'Gemini 仍处于速率限制 — 请发送 "continue" 重试。',
  ...
  settings: {
    ...
    gitHub: {
      ...
      logout: '退出登录',
      workingFolder: '工作文件夹',
      workingFolderHint: '开始新聊天时，Hermes 会话将在此文件夹中运行。',
      noWorkingFolder: '未设置工作文件夹',
      chooseWorkingFolder: '选择工作文件夹',
      createRepo: '创建仓库',
      createRepoHint: '在没有仓库的文件夹中初始化 git 仓库，然后将其用作工作文件夹。',
      creatingRepo: '正在创建仓库…',
      repoCreated: '仓库已创建',
      ...
      sortByName: '名称',
      sortByLastCommit: '最近提交',
      openRepoFolder: '打开文件夹',
      openRepoOnGitHub: '在 GitHub 上打开',
      openRepoFolderFailed: '无法打开文件夹',
      syncFork: count => `同步 ${count}`,
      syncForkHint: count => `更新分支，通过从上游仓库同步 ${count} 个提交来保持此分支最新。`,
      syncingFork: '同步中。',
      forkSynced: '分叉已与上游同步',
      ...
      pullFailed: '无法更新仓库',
      pushToOrigin: count => `推送 ${count}`,
      pushToOriginHint: '将本地提交推送到 GitHub 上的仓库',
      pushing: '正在推送…',
      pushedToOrigin: '仓库已推送到 origin',
      pushFailed: '无法推送仓库',
      refreshSync: '刷新状态',
      branchHasConflicts: '此分支存在必须解决的冲突',
      ...
      noConflictsLeft: '所有冲突已解决，请继续合并以完成。',
      conflicted: '有冲突',
      conflictContentUnavailable: '内容不可用（二进制或文件过大，无法预览）',
      acceptOurs: '保留当前分支版本',
      acceptTheirs: '保留合并分支版本',
      acceptBoth: '保留双方版本',
      continueMerge: '继续合并',
      continueMergeHint: '创建合并提交以完成合并',
      confirmAbort: '确认中止',
      abortMerge: '中止合并',
      mergeCompleted: '合并完成',
      mergeAborted: '已中止合并',
    ...
    gitLab: {
      title: 'GitLab',
      notConnected: '未连接 GitLab CLI 配置文件。',
      connectHint: '使用个人访问令牌连接，以便在 Hermes 中使用 GitLab。',
      connected: '已连接',
      logout: '退出登录',
      loginFailed: '无法使用该令牌登录 GitLab。',
      tokenTitle: '使用个人访问令牌连接',
      tokenHint: '在 GitLab 上创建一个具有 `api` 和 `read_user` 权限的令牌，然后粘贴到此处。',
      tokenLabel: '个人访问令牌',
      tokenPlaceholder: 'glpat-…',
      createToken: '在 GitLab 上创建令牌',
      workingFolder: '工作文件夹',
      workingFolderHint: '开始新聊天时，Hermes 会话在此文件夹中运行。',
      noWorkingFolder: '未设置工作文件夹',
      chooseWorkingFolder: '选择文件夹',
      createRepo: '创建仓库',
      createRepoFailed: '无法创建仓库',
      notInsideRepo: '该文件夹不在 git 仓库中',
      workingFolderUpdated: '工作文件夹已更新',
      localRepositories: 'GitLab 仓库',
      localRepositoriesHint: '在此电脑上找到的 GitLab 托管仓库。选择一个作为工作文件夹。',
      jDriveRepositories: 'AI Products 仓库',
      jDriveRepositoriesHint: '在 J:\\AI_Products 中找到的 GitLab 托管仓库。选择一个作为工作文件夹。',
      sortByName: '名称',
      sortByLastCommit: '最近提交',
      openRepoFolder: '打开文件夹',
      openRepoOnGitHub: '在 GitHub 上打开',
      openRepoOnGitLab: '在 GitLab 上打开',
      openRepoFolderFailed: '无法打开该文件夹',
      syncFork: count => `同步 ${count}`,
      syncingFork: '同步中…',
      forkSynced: 'Fork 已与上游同步',
      syncForkFailed: '无法同步 fork',
      scanningRepos: '正在扫描…',
      noReposFound: '未找到仓库',
      useThisRepo: '使用此文件夹',
      pullFromOrigin: count => `拉取 ${count}`,
